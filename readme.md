...
```shell
GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/micro-easy/go-zero
```
...
0. 完整示例请查看
    ...
    [快速构建高并发微服务](https://github.com/micro-easy/zero-doc/blob/main/doc/shorturl.md)

    [快速构建高并发微服务 - 多 RPC 版](https://github.com/micro-easy/zero-doc/blob/main/docs/frame/bookstore.md)
...
1. 安装 goctl 工具
    ...
    ```shell
    GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/micro-easy/go-zero/tools/goctl
    ```
...
2. 快速生成 api 服务
    ...
    编写业务代码：
      ...
      * api 文件定义了服务对外暴露的路由，可参考 [api 规范](https://github.com/micro-easy/zero-doc/blob/main/doc/goctl.md)
...
* API 文档 (逐步完善中)
  ...
  [https://www.yuque.com/micro-easy/go-zero](https://www.yuque.com/micro-easy/go-zero)

* awesome 系列
  * [快速构建高并发微服务](https://github.com/micro-easy/zero-doc/blob/main/doc/shorturl.md)
  * [快速构建高并发微服务 - 多 RPC 版](https://github.com/micro-easy/zero-doc/blob/main/docs/frame/bookstore.md)
  * [goctl 使用帮助](https://github.com/micro-easy/zero-doc/blob/main/doc/goctl.md)
  * [通过 MapReduce 降低服务响应时间](https://github.com/micro-easy/zero-doc/blob/main/doc/mapreduce.md)
  * [关键字替换和敏感词过滤工具](https://github.com/micro-easy/zero-doc/blob/main/doc/keywords.md)
  * [进程内缓存使用方法](https://github.com/micro-easy/zero-doc/blob/main/doc/collection.md)
  * [防止缓存击穿之进程内共享调用](https://github.com/micro-easy/zero-doc/blob/main/doc/sharedcalls.md)
  * [基于 prometheus 的微服务指标监控](https://github.com/micro-easy/zero-doc/blob/main/doc/metric.md)
  * [文本序列化和反序列化](https://github.com/micro-easy/zero-doc/blob/main/doc/mapping.md)
  * [快速构建 jwt 鉴权认证](https://github.com/micro-easy/zero-doc/blob/main/doc/jwt.md)
...
项目地址：[https://github.com/micro-easy/go-zero](https://github.com/micro-easy/go-zero)
